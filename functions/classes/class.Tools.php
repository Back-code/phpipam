...
class Tools extends Common_functions {
	...
	public function search_subnets($search_term, $high = "", $low = "", $search_req, $custom_fields = array()) {
		...
		$result = array_merge($result1, $result2, $result3);			$results = [];
	    # result			foreach (array_merge($result1, $result2, $result3) as $result) {
	    return array_filter($result);				$results[$result->id] = $result;
		}
		# result
		return $results;
	}
